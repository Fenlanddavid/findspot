        ...
        {gpsError && (
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              className="self-start rounded-lg border border-red-200 px-3 py-2 text-xs font-bold text-red-700 transition-colors hover:border-red-300 hover:bg-red-50 dark:border-red-800 dark:text-red-300 dark:hover:bg-red-950/30"
            >
              Continue without GPS - add location later
            </button>
          </div>
        )}
      </div>
