    ...
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3 pointer-events-none">
      ...
      {showSuccess && (
          <div className="pointer-events-auto bg-gray-900/95 backdrop-blur-md text-white p-3 rounded-2xl shadow-2xl flex flex-col gap-2 animate-in slide-in-from-right-4 border border-emerald-500/30 mb-2 w-52">
              ...
              <label className="bg-emerald-600 hover:bg-emerald-500 text-white px-3 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest cursor-pointer active:scale-95 transition-all flex items-center justify-center gap-1.5">
                  📸 Photo
              ...
              <div className="flex gap-1.5">
                  <button
                    ...
                    className="flex-1 bg-gray-700 hover:bg-gray-600 text-white py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all"
                  >
                    Edit →
                  </button>
                  <button
                    onClick={() => setShowSuccess(false)}
                    className="flex-1 bg-gray-800 hover:bg-gray-700 text-gray-300 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all"
                  >
                    Done
                  </button>
              </div>
              <button
                ...
                className="text-[9px] text-red-400 hover:text-red-300 opacity-50 hover:opacity-100 text-center transition-all"
              >
                Undo
              </button>
          </div>
