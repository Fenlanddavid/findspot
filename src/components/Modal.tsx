        ...
        {props.headerActions ? (
          <>
            <div className="flex justify-between items-center gap-2 mb-2">
              <h2 className="m-0 text-xl font-bold tracking-[0.3px] opacity-50 truncate">{props.title}</h2>
              <button onClick={props.onClose} className="shrink-0 p-2 rounded-xl transition-all duration-[140ms] text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-white/[0.08] active:bg-gray-200 dark:active:bg-white/[0.05] active:scale-95">
