...
import { CoachTip } from '../components/CoachTips';
...
import {
    FieldGuideContext,
    HOTSPOT_TITLES,
} from '../components/fieldGuide/FieldGuideContext';
...
export default function FieldGuideController({ projectId, onSignificantFind }: { projectId: string; onSignificantFind?: (initialContext?: Partial<WorkflowState>) => void }) {
