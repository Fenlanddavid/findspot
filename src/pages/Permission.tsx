...
export default function PermissionPage(props: {
  ...
  const canManageClubDayPack = isEdit && !isClubDayMember && !isPersonalRallyRecord && isSharedPermission;
  ...
  const canUseAgreement = isEdit && !isClubDayMember && !isPersonalRallyRecord && !isRally;
