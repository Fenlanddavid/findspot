    ...
    <div className="max-w-6xl mx-auto pb-10 px-4">
      <header className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6 mt-4">
        ...
        <div className="relative flex-1 max-w-md">
            ...
            <input type="text" placeholder="Search objects, notes, periods..." value={searchQuery} onChange={(e) => { const v = e.target.value; setSearchQuery(v); const p = new URLSearchParams(searchParams); if (v) p.set('q', v); else p.delete('q'); setSearchParams(p, { replace: true }); }} className="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl py-2.5 pl-10 pr-4 shadow-sm focus:ring-2 focus:ring-emerald-500 outline-none transition-all text-sm" />
        </div>
      </header>
